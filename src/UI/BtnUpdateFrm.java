...
public class BtnUpdateFrm extends JFrame{
	...
	public BtnUpdateFrm(String qtype,String qtitle,String qa,String qb,
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				String sql="UPDATE t_timu SET qtype='"+txttype.getText()+"',qtitle='"+txtTitle.getText()+"',qa='"+txtA.getText()+"',qb='"+txtB.getText()+"',qc='"+txtC.getText()+"',qd='"+txtD.getText()+"',qanswer='"+txtanswer.getText()+"'WHERE qtitle='"+oldtitle+"'";
